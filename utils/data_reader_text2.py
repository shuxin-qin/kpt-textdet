...
class DataReader(object):
    ...
    def __getitem__(self, idx):
        ...
        output_h = self.config.IMAGE_HEIGHT
        output_w = self.config.IMAGE_WIDTH
        ...
        return img, hm, wh, reg, reg_mask, ind, hm_hp, hp_offset, hp_ind, hp_mask, kps, kps_mask, kpwidth, gt_kernals
