...
def inference():
    ...
    ckpt_path='./checkpoint/td500/weight50_td500-57500'
    sess = tf.Session()
    cfgs = cfg_text_td500.Config()
    ...
    img_folder = 'data/MSRA-TD500/test/images1'
    out_path = 'data/MSRA-TD500/test/out1'
    ...
    for i, img_name in enumerate(img_names):
        ...
        #    write_result_as_txt(txt_name, polygons, 'data/MSRA-TD500/txt')
        ...
        h_mname = os.path.join(out_path, img_name.replace('.JPG', '_04.jpg'))
