...
def inference():
    ...
    ckpt_path='./checkpoint/icdar/weight50_icdar-50000'
    sess = tf.Session()
    cfgs = cfg_text_icdar.Config()
    ...
    img_folder = 'data/icdar2015/test/images1'
    out_path = 'data/icdar2015/test/out1'
    ...
    for i, img_name in enumerate(img_names):
        ...
        if cfgs.use_nms:
            ...
            if len(results) > 0:
                ...
                #print(kp_wids)
                #print(bboxes)
                #polygons = text_draw_on_img(original_image, scores, bboxes, kps, kp_wids, thickness=2, drawkp=False)
        ...
        #    write_result_as_txt(txt_name, polygons, 'data/icdar2015/test/txt')
        ...
        hname = os.path.join(out_path, img_name.replace('.jpg', '_06.jpg'))
