...
def train(checkpoint=None):
    ...
    learning_rate = tf.train.piecewise_constant(global_step, [5000, 10000], [0.0002, 0.00005, 0.00001])
    ...
    with tf.Session(config=tf.ConfigProto(gpu_options=gpu_options, allow_soft_placement=True)) as sess:
        ...
        for epoch in range(1, 1+configs.epochs):
            ...
            if epoch % 10 == 0:
                saver.save(sess, "./checkpoint/ctw/weight50_ctw3", global_step=global_step)
